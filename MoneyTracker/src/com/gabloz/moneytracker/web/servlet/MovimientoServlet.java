...
public class MovimientoServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 4649780650188810866L;
	private static final Logger logger = Logger
			.getLogger(MovimientoServlet.class.getCanonicalName());
	...
	protected void doGet(HttpServletRequest request,
		...
		if (usuario == null) {
			...
			out.println(" { \"movimientos\" :"
					+ Arrays.toString(movimientoBO.findByUsuario(
							usuario.getNickname()).toArray()) + "}");
		}
	}
		...
		if (usuario == null) {
			...
			try {
				...
				movimientoBO.createOrUpdate(valor, descripcion, fecha,
						idCuenta1, idCuenta2, tipoOp1, tipoOp2, usuario, concepto, null);
